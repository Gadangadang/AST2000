...
def launch_and_orient_spacecraft(mission,
                                 launch_direction,
                                 time_of_launch,fuel_consumtion,thrust):
    """
    ...
    shortcuts.place_spacecraft_on_escape_trajectory(thrust,fuel_consumtion,time_of_launch,20000000,\
    launch_direction, 80000)
    ...
    time_of_measurement = time_of_launch
...
if __name__ == '__main__':
    ...
    A = mission.save("Part4_done.py",mission,verbose=True)
